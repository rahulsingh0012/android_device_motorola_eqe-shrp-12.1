...
SHRP_DEVICE_CODE := shrp-12.1

# Recovery Type (for "About" section only)
# Default (if not set): N/A
SHRP_REC_TYPE := beta__shrp-12.1
...
# Addon #5 - Name
SHRP_EXTERNAL_ADDON_5_NAME := FIX_STUCK
# Addon #5 - Description
SHRP_EXTERNAL_ADDON_5_INFO := "MOTO_ENCRYPTION_FIX"
# Addon #5 - Addon file name as ZIP (zip format is required)
SHRP_EXTERNAL_ADDON_5_FILENAME := DFE-NEO-2.zip
